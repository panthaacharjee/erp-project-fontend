...
const ManagerDashboard = () => {
  ...
  const [lPerRate, setLPerRate] = useState();
  const [lTotalTaka, setLTotalTaka] = useState();
        ...
        <div className="fixed h-full  w-full top-0 left-0 flex justify-center items-center bg-box">
          <div className="bg-blue-500  w-full md:w-5/12 mx-4 md:mx-0 p-5 rounded-xl h-5/6 mt-10   ">
            ...
            <div className="overflow-y-scroll h-5/6">
              ...
              />
              <p className="mt-5">Per Rate</p>
              <input
                type="text"
                placeholder="Enter your amount"
                className="w-full mt-2 p-2"
                onChange={(e) => setLPerRate(e.target.value)}
              />
              <p className="mt-5">Total Taka</p>
              <input
                type="text"
                placeholder="Enter your amount"
                className="w-full mt-2 p-2"
                onChange={(e) => setLTotalTaka(e.target.value)}
              />
              ...
              <input
                ...
                placeholder="Enter your amount"
                className="w-full mt-2 p-2"
                onChange={(e) => setLRemarks(e.target.value)}
              />
            </div>
            <button
              className="bg-box px-8 py-1 mt-8 m-auto block text-white font-poppins font-medium"
