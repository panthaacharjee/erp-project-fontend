...
export const updateAdminReducer = createReducer(initialState, {
  ...
  UpdateAdminProfileFail: (state, action) => {
    state.loading = false;
    state.error = action.payload;
  },

  UpdateAdminAvatarRequest: (state) => {
    state.loading = true;
  },
  UpdateAdminAvatarSuccess: (state, action) => {
    state.loading = false;
    state.success = action.payload;
  },
  UpdateAdminAvatarFail: (state, action) => {
    state.loading = false;
    state.error = action.payload;
  },
